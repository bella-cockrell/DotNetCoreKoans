...
namespace DotNetCoreKoans.Koans
{
    public class AboutDelegates : Koan
    {
        ...
        public void DelegatesAreReferenceTypes()
        {
            ...
            BinaryOp op = null;
            Assert.Null(op); //don't understand why assert won't work otherwise
        }
        [Step(2)]
        ...
        public void BuiltInPredicateDelegateIntSatisfied()
        {
            ...
            Predicate<int> i = i => i.Equals(42); //not sure if I've done this correctly
            Assert.True(i(42));
        }
        [Step(17)]
        public void BuiltInPredicateDelegateStringSatisfied()
        {
            ...
            Predicate<string> s = s => s.Equals("42");  //not sure if I've done this correctly
            Assert.True(s("42")); 
