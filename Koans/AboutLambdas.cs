...
namespace DotNetCoreKoans.Koans
{
    public class AboutLambdas : Koan
    {
        ...
        public void BlockNotNeededOnSingleStatementLambdas()
        {
            ...
            //When you have only one statement, the curly brackets are not needed. What other two things are also missing? (Type, parentheses, return statement, semicolon after .ToString() )
            Assert.Equal(new string[] { "1", "2", "3", "4" }, anonymous);
        }
    }
}